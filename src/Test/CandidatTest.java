...
public class CandidatTest {
	...
	public void testDelete() {
		Inscriptions inscriptions = Inscriptions.getInscriptions();
		Personne Personne = inscriptions.createPersonne("lala", "lolo", "lili");
		Personne.delete();
	...
	public void testCompareTo() {
		...
		Inscriptions inscriptions = Inscriptions.getInscriptions();
		Personne Personne = inscriptions.createPersonne("na", "no", "ne");
		Personne Personne1 = inscriptions.createPersonne("na", "no", "ne");
	...
	public void testToString() {
		Inscriptions inscriptions = Inscriptions.getInscriptions();
		Personne Personne = inscriptions.createPersonne("Kalista", "Anis", "ohoh");
