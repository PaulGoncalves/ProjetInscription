...
public class CompetitionTest {
	...
	public void testGetNom() {
		...
		Competition compet = inscriptions.createCompetition("Tournoi de test", null, true);
		assertEquals("Tournoi de test", compet.getNom());
	}

	@Test
	public void testSetNom() {
		inscriptions.Inscriptions inscriptions = getInscriptions();
		Competition compet = inscriptions.createCompetition("bob", null, true);
		compet.setNom("bob");
		assertEquals("bob", compet.getNom());
	}
	...
	public void testInscriptionsOuvertes() {
		...
		Inscriptions inscriptions = Inscriptions.getInscriptions();
		Competition compet = inscriptions.createCompetition("Vayne", LocalDate.now(), true);
	...
	public void testAddEquipe() {
		...
		Equipe eee = inscriptions.createEquipe("Vayne");
